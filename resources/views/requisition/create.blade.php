      ...
      <div class="col-sm-12">
      	<div class="card">
            ...
            <div class="card-header-actions">
              <a class="btn btn-primary btn-sm" href="{{route('requisition.index')}}">Requisition List</a>
            </div>
      		</div>
      		<div class="card-body">
            ...
            <div class="row">
              <div class="form-group col-sm-6">
                ...
                <div class="row">
                <div class="col-sm-6">
                  <input class="form-control" id="when_wanted" name="when_wanted" type="date" value="{{old('when_wanted')}}">
                </div>
                <div class="col-sm-6">
